<form name="stolikiFormularz" action="<?= Router::utworz_link(array('controller' => 'Stoliki', 'action' => 'dodaj')) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="stolikiFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
