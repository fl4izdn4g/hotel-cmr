<form name="menuFormularz" action="<?= Router::utworz_link(array('controller' => 'Menu', 'action' => 'edytuj', 'id' => View::pobierz('men_id'))) ?>" method="post">
<div class="box box-solid">
	<div class="box-header">
		<a href="<?= Router::utworz_link(array('controller' => 'PotrawyMenu', 'action' => 'lista', 'menu_id' => View::pobierz('men_id')))?>" class="btn btn-primary pull-right"><span class="fa fa-fw fa-flask"></span> Potrawy w menu</a>
	</div>
	<div class="box-body">
		<div class="row">
			<div class="col-md-6">
	...
	<div class="box-footer">
		<button name="menuFormularz" value="edytuj" type="submit" class="btn btn-success">Zapisz</button>
