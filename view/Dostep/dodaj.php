<form name="dostepFormularz" action="<?= Router::utworz_link(array('controller' => 'Dostep', 'action' => 'dodaj')) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="dostepFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
