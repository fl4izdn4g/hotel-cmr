<form name="produktyFormularz" action="<?= Router::utworz_link(array('controller' => 'Produkty', 'action' => 'dodaj')) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
	  <button name="produktyFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
