<form name="goscFormularz" action="<?= Router::utworz_link(array('controller' => 'GoscieHotelowi', 'action' => 'dodaj', 'user_id' => View::pobierz('user_id'))) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="goscFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
