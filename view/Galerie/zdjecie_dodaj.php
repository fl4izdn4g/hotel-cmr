<form name="zdjecieFormularz" action="<?= Router::utworz_link(array('controller' => 'Galerie', 'action' => 'zdjecie_dodaj', 'gallery_id' => View::pobierz('gallery_id'))) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="zdjecieFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
