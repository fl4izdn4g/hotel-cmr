<form name="galeriaFormularz" action="<?= Router::utworz_link(array('controller' => 'Galerie', 'action' => 'edytuj', 'id' => View::pobierz('gal_id'))) ?>" method="post">
<div class="box box-solid">
	<div class="box-header">
		<a href="<?= Router::utworz_link(array('controller' => 'Galerie', 'action' => 'zdjecia', 'gallery_id' => View::pobierz('gal_id')))?>" class="btn btn-primary pull-right"><span class="fa fa-fw fa-file-image-o"></span> Zdjęcia</a>
	</div>
	<div class="box-body">
		<div class="row">
			<div class="col-md-8">
	...
	<div class="box-footer">
		<button name="galeriaFormularz" value="edytuj" type="submit" class="btn btn-success">Zapisz</button>
