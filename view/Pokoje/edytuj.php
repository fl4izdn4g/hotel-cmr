<form name="pokojFormularz" action="<?= Router::utworz_link(array('controller' => 'Pokoje', 'action' => 'edytuj', 'id' => View::pobierz('pok_id'))) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="pokojFormularz" value="edytuj" type="submit" class="btn btn-success">Zapisz</button>
