<form name="potrawaFormularz" action="<?= Router::utworz_link(array('controller' => 'Potrawy', 'action' => 'dodaj')) ?>" method="post">
<div class="box box-solid">
	<div class="box-header">
		<a class="btn btn-primary pull-right disabled"><span class="fa fa-fw fa- fa-cubes"></span> Produkty dla potrawy</a>
	</div>
	<div class="box-body">
		<div class="row">
			<div class="col-md-8">
	...
	<div class="box-footer">
	  <button name="potrawaFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
