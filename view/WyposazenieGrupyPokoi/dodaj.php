<form name="wyposazenieFormularz" action="<?= Router::utworz_link(array('controller' => 'WyposazenieGrupyPokoi', 'action' => 'dodaj', 'group_id' => View::pobierz('group_id'))) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="wyposazenieFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
