<form name="admnistratorFormularz" action="<?= Router::utworz_link(array('controller' => 'Administratorzy', 'action' => 'dodaj', 'user_id' => View::pobierz('user_id'))) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="admnistratorFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
