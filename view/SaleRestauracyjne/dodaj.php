<form name="saleFormularz" action="<?= Router::utworz_link(array('controller' => 'SaleRestauracyjne', 'action' => 'dodaj')) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="saleFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
