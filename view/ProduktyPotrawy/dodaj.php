<form name="potrawyFormularz" action="<?= Router::utworz_link(array('controller' => 'ProduktyPotrawy', 'action' => 'dodaj', 'meal_id' => View::pobierz('meal_id'))) ?>" method="post">
<div class="box box-solid">
	...
	<div class="box-footer">
		<button name="potrawyFormularz" value="dodaj" type="submit" class="btn btn-success">Zapisz</button>
