    ...
    private function errorCodeToMsg($code) {
        switch($code) {
            case UPLOAD_ERR_INI_SIZE:
                $message = 'Plik ma za du�y rozmiar.';
                break;
            case UPLOAD_ERR_PARTIAL:
                $message = 'Nie udało się wgrać pliku w całości.';
                break;
            case UPLOAD_ERR_NO_FILE:
                $message = 'Nie udało się wgrać pliku.';
                break;
            case UPLOAD_ERR_NO_TMP_DIR:
                $message = 'Brak katalogu tymczasowego.';
                break;
            case UPLOAD_ERR_CANT_WRITE:
                $message = 'Nie mo�na zapisać pliku na dysku.';
                break;
            case UPLOAD_ERR_EXTENSION:
                $message = 'Niepoprawne rozszerzenie pliku.';
                break;
            default:
